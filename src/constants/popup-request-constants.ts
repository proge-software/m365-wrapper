export default class PopupRequestConstants {
    static readonly DEFAULT_SCOPES: string[] = ['Calendars.ReadWrite', 'Calendars.Read.Shared',
    ...
    static readonly PROMPT_SELECT_ACCOUNT: string = "select_account";
}